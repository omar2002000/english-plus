...
const TITLES: Record<ScreenKey, string> = {
  ...
  revenue_forecast: 'حاسبة الدخل',
  contact_log: 'سجل التواصل',
...
const SECTION_COLORS: Partial<Record<ScreenKey, string>> = {
  ...
  revenue_forecast: 'from-emerald-700 to-emerald-900',
  contact_log: 'from-blue-700 to-blue-900',
  calendar: 'from-violet-700 to-violet-900',
  todo: 'from-cyan-700 to-cyan-900',
