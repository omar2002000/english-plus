...
import { RevenueForecastScreen } from '@/components/screens/RevenueForecastScreen';
import { ContactLogScreen } from '@/components/screens/ContactLogScreen';
...
function renderScreen(screen: string) {
  switch (screen) {
    ...
    case 'revenue_forecast': return <RevenueForecastScreen />;
    case 'contact_log': return <ContactLogScreen />;
